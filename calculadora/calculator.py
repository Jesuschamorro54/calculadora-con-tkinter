...
class Interfaz:
    def __init__(self, ventana):
        ...
        #Tablero
        self.tablero = Text(self.ventana, state="disabled", width=27, height=3, background="gray83", foreground="black", font = ("Helvetica",12))
        ...
        boton4 = Button(self.ventana, text=(u"\u232B"), width="7", height=2, command=lambda: self.click((u"\u232B"), False), background= "#FD6868")  # Borrar
        ...
        boton17 = Button(self.ventana, text="=", width="33", height=2, command=lambda: self.click("=", False), background="#99A4A4")
        boton17.place(x=8, y=242)

    def Crear_Boton_Numeros(self, valor, escribir=True, ancho=7, alto=2):
        return Button(self.ventana, text=valor, width=ancho, height=alto, command=lambda: self.click(valor, escribir), background= "#C6CBCB", font = ("Helvetica",9))

    def Crear_Boton_Operaciones(self, valor, escribir=True, ancho=7, alto=2):
        return Button(self.ventana, text=valor, width=ancho, height=alto, command=lambda: self.click(valor, escribir),background="#FFB300",font = ("Helvetica",9))
